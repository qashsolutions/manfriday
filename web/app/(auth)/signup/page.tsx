  ...
  return (
    <div className="card space-y-6 max-w-md mx-auto">
      <div className="text-center space-y-1">
        <h2 className="text-lg font-semibold">Get started with ManFriday</h2>
        <p className="text-xs text-muted">Sign up to build your personal knowledge base</p>
      </div>

      {error && <p className="text-sm text-red-400 text-center">{error}</p>}

      {/* Google — primary sign up */}
      <button
        onClick={handleGoogleSignup}
        className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-medium py-3 px-4 rounded-lg border border-gray-300 transition-colors"
      >
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-surface-1 px-3 text-muted">or use email</span>
        </div>
      </div>
